// Add a function, the input parameter is a string, and the output is a string with the first letter of each word capitalized.
function getEnglishName(name) {
    // find the words in names which is closest to the given name with the minimum edit distance
    let distance = 1000000;
    let result = "";
    for (let i = 0; i < names.length; i++) {
        const temp = getEditDistance(name, names[i]);
        if (temp < distance) {
            distance = temp;
            result = names[i];
        }
